...
int main(){
	...
	int iter=5;
	clock_t read_input_and_obstacle_tStart = clock();	
	...
	clock_t read_input_and_obstacle_tEnd = clock();
	printf("Time taken to read the input and the obstacle: %.6fs\n", (double)(read_input_and_obstacle_tEnd - read_input_and_obstacle_tStart)/CLOCKS_PER_SEC);
